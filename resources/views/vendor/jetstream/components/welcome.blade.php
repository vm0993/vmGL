                ...
                <div class="col-span-12 sm:col-span-6 md:col-span-4 py-6 sm:pl-5 md:pl-0 lg:pl-5 relative text-center sm:text-left">
                    ...
                    <div class="xxl:flex mt-5 mb-3">
                        <div class="flex items-center justify-center sm:justify-start">
                            <div class="text-white relative text-3xl xxl:text-4xl font-bold leading-6 pl-4">
                ...
                <div class="row-start-2 md:row-start-auto col-span-12 md:col-span-4 py-6 border-theme-11 border-t md:border-t-0 md:border-l md:border-r border-dashed px-10 sm:px-28 md:px-5 -mx-5">
                    <div class="flex flex-wrap items-center">
                        <div class="flex items-center w-full sm:w-auto justify-center sm:justify-start mr-auto mb-5 xxl:mb-0">
                            ...
                            <div class="ml-3.5">
                                <div class="relative text-white text-xl xxl:text-2xl font-medium leading-6 xxl:leading-5 pl-3.5">
                ...
                <div class="col-span-12 md:col-span-6 xxl:col-span-12 mt-3 xxl:mt-6">
                    ...
                    <div class="report-timeline mt-5 relative">
                        <div class="intro-x relative flex items-center mb-3">
                            <div class="report-timeline__image">
                                <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                    <img alt="Tinker Tailwind HTML Admin Template" src="{{ asset('images/profile-9.jpg') }}">
                                </div>
                            </div>
                        ...
                        <div class="intro-x relative flex items-center mb-3">
                            <div class="report-timeline__image">
                                <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                    <img alt="Tinker Tailwind HTML Admin Template" src="{{ asset('images/profile-6.jpg') }}">
                                </div>
                            </div>
                            <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                <div class="flex items-center">
                                ...
                                <div class="text-gray-600">
                                    ...
                                    <div class="flex mt-2">
                                        <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Dell XPS 13">
                                            <img alt="Tinker Tailwind HTML Admin Template" class="rounded-md border border-white" src="{{ asset('images/preview-3.jpg') }}">
                                        </div>
                                        ...
                                        <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Nike Air Max 270">
                                            <img alt="Tinker Tailwind HTML Admin Template" class="rounded-md border border-white" src="{{ asset('images/preview-11.jpg') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="intro-x relative flex items-center mb-3">
                            <div class="report-timeline__image">
                                <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                    <img alt="Tinker Tailwind HTML Admin Template" src="{{ asset('images/profile-1.jpg') }}">
                                </div>
                            </div>
                            <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                <div class="flex items-center">
                        ...
                        <div class="intro-x relative flex items-center mb-3">
                            <div class="report-timeline__image">
                                <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                    <img alt="Tinker Tailwind HTML Admin Template" src="{{ asset('images/profile-5.jpg') }}">
                                </div>
                            </div>
                            <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                <div class="flex items-center">
                ...
                <div class="col-span-12 md:col-span-6 xxl:col-span-12 mt-3">
                    ...
                    <div class="mt-5">
                        ...
                        <div class="intro-x">
                            <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                    <img alt="Tinker Tailwind HTML Admin Template" src="{{ asset('images/profile-8.jpg') }}">
                                </div>
                                <div class="ml-4 mr-auto">
                        ...
                        <div class="intro-x">
                            <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                    <img alt="Tinker Tailwind HTML Admin Template" src="{{ asset('images/profile-3.jpg') }}">
                                </div>
                                <div class="ml-4 mr-auto">
                        ...
                        <div class="intro-x">
                            <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                    <img alt="Tinker Tailwind HTML Admin Template" src="{{ asset('images/profile-7.jpg') }}">
                                </div>
                                <div class="ml-4 mr-auto">
                                    <div class="font-medium">Russell Crowe</div>
