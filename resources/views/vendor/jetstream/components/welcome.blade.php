            ...
            <div class="mt-14 mb-3 grid grid-cols-12 sm:gap-10 intro-y">
                <div class="col-span-12 sm:col-span-6 md:col-span-4 py-6 sm:pl-5 md:pl-0 lg:pl-5 relative text-center sm:text-left">
                    <div class="absolute pt-0.5 xxl:pt-0 mt-5 xxl:mt-6 top-0 right-0 dropdown">
                        <a class="dropdown-toggle block" href="javascript:;" aria-expanded="false"> <i data-feather="more-vertical" class="w-5 h-5 text-theme-35"></i> </a>
                    ...
                    <div class="text-white text-sm xxl:text-base font-medium -mb-1"> Hi Angelina, <span class="text-theme-35 dark:text-gray-500 font-normal">welcome back!</span> </div>
                    <div class="text-base xxl:text-lg justify-center sm:justify-start flex items-center text-theme-35 dark:text-gray-500 leading-3 mt-14 xxl:mt-24"> My Total Assets <i data-feather="alert-circle" class="tooltip w-5 h-5 ml-1.5 mt-0.5" title="Total value of your sales: $158.409.416"></i> </div>
                    <div class="xxl:flex mt-5 mb-3">
                        <div class="flex items-center justify-center sm:justify-start">
                            <div class="text-white relative text-3xl xxl:text-4xl font-bold leading-6 pl-4"> <span class="absolute text-xl xxl:text-2xl top-0 left-0 -mt-1.5 xxl:mt-0">$</span> 18,402,210 </div>
                            <a class="text-gray-500 ml-4 xxl:ml-16" href=""> <i data-feather="refresh-ccw" class="w-5 h-5"></i> </a>
                        </div>
                        <div class="mt-5 xxl:flex xxl:justify-center xxl:mt-0 xxl:-ml-20 xxl:w-14 xxl:flex-none xxl:pl-1">
                            <div class="font-medium inline-flex bg-theme-20 text-white rounded-full px-2 py-1 text-xs xxl:text-sm xxl:p-0 xxl:text-theme-20 xxl:bg-transparent xxl:flex items-center tooltip cursor-pointer xxl:justify-center" title="49% Higher than last month"> 49% <i data-feather="chevron-up" class="w-4 h-4 ml-0.5"></i> </div>
                        </div>
                    </div>
                    <div class="text-theme-35 text-xs mt-5">Last updated 1 hour ago</div>
                    <div class="xxl:text-base text-theme-35 mt-6 -mb-1"> Total net margin <span class="font-medium">$921,050</span> </div>
                ...
                <div class="row-start-2 md:row-start-auto col-span-12 md:col-span-4 py-6 border-theme-11 border-t md:border-t-0 md:border-l md:border-r border-dashed px-10 sm:px-28 md:px-5 -mx-5">
                    <div class="flex flex-wrap items-center">
                        <div class="flex items-center w-full sm:w-auto justify-center sm:justify-start mr-auto mb-5 xxl:mb-0">
                            ...
                            <div class="ml-3.5">
                                <div class="relative text-white text-xl xxl:text-2xl font-medium leading-6 xxl:leading-5 pl-3.5"> <span class="absolute text-base xxl:text-lg font-bold top-0 left-0 xxl:-mt-1.5">$</span> 47,578.77 </div>
                    ...
                    <div class="mt-12 text-xs text-gray-300 dark:text-gray-500">You have spent about 35% of your annual budget.</div>
                ...
                <div class="box p-5 mt-6 bg-theme-25 intro-x">
                    <div class="flex flex-wrap gap-3">
                        <div class="mr-auto">
                            ...
                            <div class="text-white relative text-2xl font-medium leading-5 pl-3.5 mt-3.5"> <span class="absolute text-lg font-bold top-0 left-0 -mt-1.5">$</span> 47,578.77 </div>
                        </div>
                ...
                <div class="mt-5">
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                            ...
                            <div class="ml-4 mr-auto">
                                ...
                                <div class="text-gray-600 text-xs mt-0.5">22 December 2020</div>
                            </div>
                    ...
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                            ...
                            <div class="ml-4 mr-auto">
                                ...
                                <div class="text-gray-600 text-xs mt-0.5">15 January 2022</div>
                            </div>
                            <div class="py-1 px-2 rounded-full text-xs bg-theme-6 dark:bg-theme-20 text-white cursor-pointer font-medium">137 Sales</div>
                        </div>
                    </div>
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                            ...
                            <div class="ml-4 mr-auto">
                                ...
                                <div class="text-gray-600 text-xs mt-0.5">31 May 2022</div>
                            </div>
                            <div class="py-1 px-2 rounded-full text-xs bg-theme-6 dark:bg-theme-20 text-white cursor-pointer font-medium">137 Sales</div>
                        </div>
                    </div>
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                            ...
                            <div class="ml-4 mr-auto">
                                <div class="font-medium">Russell Crowe</div>
                                <div class="text-gray-600 text-xs mt-0.5">21 May 2020</div>
                            </div>
                            <div class="py-1 px-2 rounded-full text-xs bg-theme-6 dark:bg-theme-20 text-white cursor-pointer font-medium">137 Sales</div>
                        </div>
                    </div>
                        ...
                        <tbody>
                                ...
                                <td class="w-40">
                                    <div class="flex">
                                        <div class="w-10 h-10 image-fit zoom-in">
                                            <img alt="Tinker Tailwind HTML Admin Template" class="tooltip rounded-full" src="dist/images/preview-13.jpg" title="Uploaded at 22 December 2020">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                            <img alt="Tinker Tailwind HTML Admin Template" class="tooltip rounded-full" src="dist/images/preview-5.jpg" title="Uploaded at 2 September 2021">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                            <img alt="Tinker Tailwind HTML Admin Template" class="tooltip rounded-full" src="dist/images/preview-4.jpg" title="Uploaded at 15 August 2020">
                                        </div>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr class="intro-x">
                                <td class="w-40">
                                    <div class="flex">
                                        <div class="w-10 h-10 image-fit zoom-in">
                                            <img alt="Tinker Tailwind HTML Admin Template" class="tooltip rounded-full" src="dist/images/preview-3.jpg" title="Uploaded at 15 January 2022">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                            <img alt="Tinker Tailwind HTML Admin Template" class="tooltip rounded-full" src="dist/images/preview-3.jpg" title="Uploaded at 28 October 2022">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                            <img alt="Tinker Tailwind HTML Admin Template" class="tooltip rounded-full" src="dist/images/preview-6.jpg" title="Uploaded at 10 May 2022">
                                        </div>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr class="intro-x">
                                <td class="w-40">
                                    <div class="flex">
                                        <div class="w-10 h-10 image-fit zoom-in">
                                            <img alt="Tinker Tailwind HTML Admin Template" class="tooltip rounded-full" src="dist/images/preview-4.jpg" title="Uploaded at 31 May 2022">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                            <img alt="Tinker Tailwind HTML Admin Template" class="tooltip rounded-full" src="dist/images/preview-2.jpg" title="Uploaded at 28 May 2021">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                            <img alt="Tinker Tailwind HTML Admin Template" class="tooltip rounded-full" src="dist/images/preview-8.jpg" title="Uploaded at 24 April 2021">
                                        </div>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr class="intro-x">
                                <td class="w-40">
                                    <div class="flex">
                                        <div class="w-10 h-10 image-fit zoom-in">
                                            <img alt="Tinker Tailwind HTML Admin Template" class="tooltip rounded-full" src="dist/images/preview-6.jpg" title="Uploaded at 21 May 2020">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                            <img alt="Tinker Tailwind HTML Admin Template" class="tooltip rounded-full" src="dist/images/preview-4.jpg" title="Uploaded at 14 August 2021">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                            <img alt="Tinker Tailwind HTML Admin Template" class="tooltip rounded-full" src="dist/images/preview-2.jpg" title="Uploaded at 30 January 2021">
                                        </div>
                                    </div>
                                </td>
                                <td>
                    ...
                    <div class="report-timeline mt-5 relative">
                                ...
                                <div class="text-gray-600">
                                    ...
                                    <div class="flex mt-2">
                                        <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Dell XPS 13">
                                            <img alt="Tinker Tailwind HTML Admin Template" class="rounded-md border border-white" src="dist/images/preview-3.jpg">
                                        </div>
                        ...
                        <div class="intro-x relative flex items-center mb-3">
                            ...
                            <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                ...
                                <div class="text-gray-600 mt-1">Has changed <a class="text-theme-30 dark:text-theme-25" href="">Oppo Find X2 Pro</a> price and description</div>
                            </div>
                        </div>
                        <div class="intro-x relative flex items-center mb-3">
                            <div class="report-timeline__image">
                            ...
                            <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                ...
                                <div class="text-gray-600 mt-1">Has changed <a class="text-theme-30 dark:text-theme-25" href="">Nikon Z6</a> description</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mt-5">
                        <div class="intro-x">
                            <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                ...
                                <div class="text-theme-20">+$20</div>
                            </div>
                        </div>
                        <div class="intro-x">
                            <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                ...
                                <div class="text-theme-21">-$32</div>
                            </div>
                        </div>
                        <div class="intro-x">
                            <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                ...
                                <div class="text-theme-20">+$141</div>
                            </div>
                        </div>
                        <div class="intro-x">
                            <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                ...
                                <div class="text-theme-21">-$29</div>
                            </div>
                        </div>
                        <div class="intro-x">
                            <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                ...
                                <div class="ml-4 mr-auto">
                                    <div class="font-medium">Leonardo DiCaprio</div>
                                    <div class="text-gray-600 text-xs mt-0.5">15 March 2022</div>
                                </div>
                                <div class="text-theme-20">+$100</div>
                            </div>
                        </div>
