...
@section('content')
    <div class="intro-y flex items-center mt-2">
        <h2 class="intro-y text-lg font-medium mt-auto">Data Personel</h2>
    </div>
    <div class="grid grid-cols-12 gap-6 mt-3">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{ route('personels.create') }}" class="btn btn-primary shadow-md mr-2">Add New</a>
            <div class="dropdown">
                ...
                <tbody>
                    ...
                    @else
                        @foreach($results as $result)
                            <tr class="intro-x">
                                <td>
                                    <a href="{{ route('personels.edit',['personel' => $result['id']]) }}">
                                        <span class="font-medium text-theme-20 whitespace-nowrap">{{ $result['name'] }}</span>
                                    </a>
                                </td>
                                <td>
                                    <span class="font-medium whitespace-nowrap">{{ $result['address'] }}</span>
                                </td>
                                <td class="w-10">
