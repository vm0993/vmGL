...
@section('content')
    <div class="intro-y flex items-center mt-2">
        <h2 class="text-lg font-medium mr-auto">New Service</h2>
    </div>
    <div class="grid grid-cols-12 gap-10 mt-2">
        <div class="intro-y col-span-12 lg:col-span-6 md:col-span-6 sm:col-span-8">
            @if(!empty($result))
            <form action="{{ route('services.update',['service'=> $result['id']]) }}" method="post">
            @else
                    ...
                    <div>
                        <div class="md:grid grid-cols-2 sm:grid grid-cols-2 gap-2">
                            <div class="input-group">
                                <div for="type" class="form-label"><strong>Category</strong></div>
                                <select 
