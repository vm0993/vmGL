...
@section('content')
    <h2 class="intro-y text-lg font-medium mt-2">Data Service</h2>
    <div class="grid grid-cols-12 gap-6 mt-2">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{ route('services.create') }}" class="btn btn-primary shadow-md mr-2">Add New</a>
            <div class="dropdown">
            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th class="px-4 py-2 w-10">Category</th>
                ...
                <tbody>
                    ...
                    @else
                        ...
                        <tr class="intro-x">
                            <td class="w-20">
                                <a href="{{ route('services.edit',['service' => $result['id']]) }}">
                                    <span class="font-medium text-theme-20 whitespace-nowrap">{{ $result['code'] }}</span>
                                </a>
                                <div class="text-xs whitespace-nowrap mt-0.5">{{ $result['name'] }}</div>
                            </td>
                            <td>
                                <span class="font-medium whitespace-nowrap">{{ $result['category_name'] }}</span>
                            </td>
                            <td>
                                <span class="text-xs whitespace-nowrap text-left">
                                    WIP : {{ $result['wip_account'] }}
                                </span><br>
                                <span class="text-xs whitespace-nowrap text-left">
                                    COGS : {{ $result['cogs_account'] }}
                                </span><br>
                                <span class="text-xs whitespace-nowrap text-left">
                                    Expense : {{ $result['expense_account'] }}
                                </span>
                            </td>
                            <td>
                            ...
                            <td>
                                <span class="font-medium whitespace-nowrap text-center"></span>
                            </td>
