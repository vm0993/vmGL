...
@section('content')
    <div class="intro-y flex items-center mt-2">
        <h2 class="intro-y text-lg font-medium mt-auto">Data Pajak</h2>
    </div>
    <div class="grid grid-cols-12 gap-6 mt-3">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{ route('taxes.create') }}" class="btn btn-primary shadow-md mr-2">Add New</a>
            <div class="dropdown">
            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th class="px-4 py-2">Tax Account</th>
                ...
                <tbody>
                    ...
                    @else
                        @foreach($results as $result)
                            <tr class="intro-x">
                                <td>
                                    <a href="{{ route('taxes.edit',['tax' => $result['id']]) }}">
                                ...
                                <td class="w-10">
                                    <span class="font-medium whitespace-nowrap text-center">{{ $result['rate'] }}</span>
                                </td>
                                <td>
                                    <span class="text-xs whitespace-nowrap">{{ $result['purchase_account'] }}</span>
                                    <div class="text-gray-600 text-xs whitespace-nowrap mt-0.5">{{ $result['sales_account'] }}</div>
                                </td>
                                <td class="w-10">
