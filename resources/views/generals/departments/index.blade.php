...
@section('content')
    <div class="intro-y flex items-center mt-2">
        <h2 class="intro-y text-lg font-medium mt-auto">Data Departemen</h2>
    </div>
    <div class="grid grid-cols-12 gap-6 mt-3">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{ route('departments.create') }}" class="btn btn-primary shadow-md mr-2">Add New</a>
            <div class="dropdown">
                ...
                <tbody>
                    ...
                    @else
                        @foreach($results as $result)
                            <tr class="intro-x">
                                <td>
                                    <a href="{{ route('departments.edit',['department' => $result['id']]) }}">
