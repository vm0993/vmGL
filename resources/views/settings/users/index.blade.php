...
@section('content')
    <h2 class="intro-y text-lg font-medium mt-4">Data User</h2>
    <div class="grid grid-cols-12 gap-6 mt-2">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{ route('users.create') }}" class="btn btn-primary shadow-md mr-2">Add New</a>
            <div class="dropdown">
        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        <th class="px-4 py-2 w-auto">User</th>
                ...
                <tbody>
                    ...
                    @else
                        ...
                        <tr class="intro-x">
                            ...
                            <td>
                                <span class="font-medium whitespace-nowrap">{{ $result['email'] }}</span>
                            </td>
                            <td>
