...
@section('content')
    <h2 class="intro-y text-lg font-medium mt-4">Data Transaksi Cash Bank</h2>
    <div class="grid grid-cols-12 gap-6 mt-2">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{ route('cash-banks.create') }}" class="btn btn-primary shadow-md mr-2">Add New</a>
            <div class="dropdown">
        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        <th class="px-4 py-2 w-auto">Voucher No</th>
                ...
                <tbody>
                    ...
                    @else
                        ...
                        <tr class="intro-x">
                            <td class="w-10">
                                <a href="{{ route('cash-banks.edit',['cash_bank' => $result['id']]) }}">
                                    <span class="font-medium text-theme-20 whitespace-nowrap">{{ $result['code'] }}</span>
                                </a>
                                <div class="text-xs text-theme-26 whitespace-nowrap mt-0.5">{{ $result['trans_date'] }}</div>
                            </td>
                            <td>
                                <span class="font-medium whitespace-nowrap">{{ $result['description'] }}</span>
                            </td>
                            <td>
                                <div class="font-medium text-theme-26 whitespace-nowrap mt-0.5 text-right">{{ $result['total'] }}</div>
                            </td>
                            <td>
