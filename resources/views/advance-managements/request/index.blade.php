...
@section('content')
    <h2 class="intro-y text-lg font-medium mt-4">Data Kasbon DO</h2>
    <div class="grid grid-cols-12 gap-6 mt-2">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{ route('advance-requests.create') }}" class="btn btn-primary shadow-md mr-2">Add New</a>
            <div class="dropdown">
        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        <th class="px-4 py-2 w-auto">Request No</th>
                ...
                <tbody>
                    ...
                    @else
                        ...
                        <tr class="intro-x">
                            <td class="w-10">
                                @if($result['status']=='ACTIVE' || $result['status']=='REJECT REPORT')
                                <a href="{{ route('advance-requests.edit',['advance_request' => $result['id']]) }}">
                            ...
                            <td>
                                ...
                                <div class="text-xs whitespace-nowrap mt-0.5">{{ __('advance-request.job_pic') }} : {{ $result['personel'] }}</div>
                            </td>
                            <td>
                                <span class="font-medium whitespace-nowrap text-center">{{ $result['request_amount'] }}</span>
                            </td>
                            <td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu w-44">
                                                <div class="dropdown-menu__content box dark:bg-dark-1 p-2">
                                                    ...
                                                    <a href="{{ route('advance-requests.submit-request',['id' => $result['id'] ]) }}" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md">
                                                        <x-feathericon-send class="w-4 h-4 mr-2"></x-feathericon-send>
                                                        <span>Submit</span>
                                                    </a>
                                                    @endif
                                                </div>
