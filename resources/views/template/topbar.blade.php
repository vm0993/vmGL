        ...
        <div class="dropdown-menu w-56">
            <div class="dropdown-menu__content box bg-theme-26 dark:bg-dark-6 text-white">
                ...
                <div class="p-2">
                    ...
                    <a href="javascript:;" onclick="initFirebaseMessagingRegistration();" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md">
                        <i data-feather="bell" class="w-4 h-4 mr-2"></i> Allow Notification
                    </a>
                    @endif
